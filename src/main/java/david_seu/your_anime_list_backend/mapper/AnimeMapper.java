...
public class AnimeMapper {
    ...
    public static AnimeDto mapToAnimeDto(Anime anime, Integer numEpisodes){
        return new AnimeDto(anime.getId(), anime.getTitle(), anime.getScore(), numEpisodes, anime.getUser().getId(), anime.getUser());
    }

    public static Anime mapToAnime(AnimeDto animeDto){
        return new Anime(animeDto.getId(), animeDto.getTitle(), animeDto.getScore(), animeDto.getUser());
    }
}
